    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Sửa nhóm</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Sửa nhóm</h4>
        ...
        <div class="br-section-wrapper">
                ...
                <div class="form-layout form-layout-1">
                    <div class="row mg-b-25">
                        <div class="col-lg-4">
                            ...
                            <input class="form-control" type="text" name="permission_id" id="permission_id" value="{{ $permission['permission_id'] ?? old('permission_id') }}" placeholder="Mã nhóm">
                            </div>
                        </div><!-- col-4 -->
                        ...
                        <div class="col-lg-4">
                            ...
                            <input class="form-control" type="text" name="permission_name" value="{{ $permission['permission_name'] ?? old('permission_name') }}" placeholder="Tên nhóm">
                            </div>
                        </div><!-- col-4 -->
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" data-placeholder="Choose country" name="permission_active">
                                ...
                                <option value="1" {{ $permission['permission_active'] == '1' ? 'selected' : '' }}>Kích hoạt</option>
                                <option value="0" {{ $permission['permission_active'] == '0' ? 'selected' : '' }}>Không kích hoạt</option>
                            </select>
                            </div>
                        </div><!-- col-4 -->
            ...
            <div class="form-layout-footer">
              <button class="btn btn-primary">OK</button>
                <a class="btn btn-danger" href="{{ route('permission.destroy', $permission['permission_id']); }}">Xoá</a>
